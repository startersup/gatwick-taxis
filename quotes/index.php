            ...
            <div class="col-md-8 nopadding heighto">
                ...
                <div class="row">
                    <div class="gt-container">
                        <div class="col-md-4">
                            <div class="quote-card top-margin">
                                <div class="float-card">10% Discount</div>
                                <div class="img-med-bar">
                                    <img src="../images/saloon.png" style="max-width:200px;width:100%;">
                                </div>
                                <p class="fleet-name">GT Provider #23</p>
                                ...
                                <p class="passenger-capacity">Up to 4 passengers per vehicle  </p>
                                <p class="discount-panel">saloon x 1</p>
                                <p class="fare">£ 140</p>
                              <a href="/book/index.html"> <button class="button">Book Now</button></a> 
                            </div>
                        </div>
                           <div class="col-md-4">
                            <div class="quote-card top-margin">
                                <div class="img-med-bar">
                                    <img src="../images/estate.png" style="max-width:200px;width:100%;">
                                </div>
                                <p class="fleet-name">GT Provider #23</p>
                                <div class="gt-star-rate">
                                    <span class="fa fa-star checked"></span>
                            ...
                            <div class="quote-card top-margin">
                                  <div class="float-card">10% Discount</div>
                                <div class="img-med-bar">
                                    <img src="../images/8-seater.png" style="max-width:200px;width:100%;">
                                </div>
                                <p class="fleet-name">GT Provider #23</p>
                                <div class="gt-star-rate">
                                    <span class="fa fa-star checked"></span>
