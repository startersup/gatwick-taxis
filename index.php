...
<div class="hellobar">
  <div class="hellobar-wrap">
    ...
    <div class="hellobar-content hidden-xs">we are back online after <span style="color:#e7f169;font-weight:bold;">COVID-19</span>, we accept Prebookings now and ready to serve clean and comfortable Taxis.
    </div>
       <div class="hellobar-content visible-xs">we are back online after<span style="color:#e7f169;font-weight:bold;">COVID-19</span> 
    </div>
  </div>
</div>
...
while($row= mysqli_fetch_array($result,MYSQLI_ASSOC))
{
  ...
  ?>
        <li><a href="<?php echo($urlname); ?>"><?php echo(str_replace("-"," ",$displayname)); ?></a></li>
       <?php
    }
            ...
            <div class="card book">
                <div class="container1">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 nopadding">
                                <input type="text" class="gt-dp" tabindex="1" placeholder="Pickup Date & Time" autocomplete="off" id="datetimepicker" name="tempDate" required>
...
<!--    <center>-->
<!--<img src="./images/christmas.png" style="width:100%;max-width:500px;">    -->
<!--</center>-->
<!--</section>-->
                ...
                <div class="col-md-3">
                    <div class="card">
                       <center> <img src="./images/2.png" style="max-width:200px;width:100%;"></center>
                        ...
                        <p class="fleet-desc">Toyato prius or Volswagen Passet Similar Car carries upto 4 passenger and 2 luggages and 1 handy luggae</p>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card">
                       <center><img src="./images/3.png" style="max-width:200px;width:100%;"></center> 
                        ...
                        <p class="fleet-desc">Skoda Superb or Toyota Avensis Similar Car carries upto 4 passenger and 3 luggages and 1 handy Luggage</p>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card">
                      <center> <img src="./images/4.png" style="max-width:200px;width:100%;"></center> 
                        ...
                        <p class="fleet-desc">Ford Galaxy or Volswagen sharon Similar Car carries upto 6 passenger and 4 luggages and 2 handy luggages</p>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card">
                        ...
                        <p class="fleet-desc">Mercedez viano or Volswagen Transporter Similar Car carries upto 7 passenger and 6 luggages and 3 handy luggages</p>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="card">
                                        ...
                                        <p class="fleet-desc">Highly recommend one of the most professional taxi services I’ve come across. Competitive pricing, great communication and the driver could not have been more helpful. Will definitely recommend and thank you for the great service.</p>
                                        <div class="gt-star-rate">
                                            <span class="fa fa-star checked"></span>
                                            <span class="fa fa-star checked"></span>
                                            <span class="fa fa-star checked"></span>
                                ...
                                <div class="col-sm-3">
                                    <div class="card">
                                        ...
                                        <p class="fleet-desc">Our taxi driver was great - the only problem was that cash payment was expected. It would have been much easier to pay on-line.</p>
                                        <div class="gt-star-rate">
                                            <span class="fa fa-star checked"></span>
                                            <span class="fa fa-star checked"></span>
                                            <span class="fa fa-star checked"></span>
                                ...
                                <div class="col-sm-3">
                                    <div class="card">
                                        ...
                                        <p class="fleet-desc">I had great time, while I am traveling in Gatwick taxi. The taxi was on time in the Gatwick airport . So that I need not to wait with my family for a long time. I feel good and satisfied with the service provide by the taxi.</p>
                                        <div class="gt-star-rate">
                                            <span class="fa fa-star checked"></span>
                                            <span class="fa fa-star checked"></span>
                                            <span class="fa fa-star checked"></span>
...
<script>
    $(document).ready(function(){   
      setTimeout(function() {
    $("#offermodal").css({'display':'block', "opacity": "1",'background-color':'rgb(0 0 0 / 26%)'});
  }, 5000);
  ...
  var myDate=    $('.ui-state-active').parent().attr("data-year")+" "+( parseInt($('.ui-state-active').parent().attr("data-month")) +1)+" "+$('.ui-state-active').html()+" "+$('#hrs').val()+" "+$('#mins').val();
  var tempDate = $('.ui-state-active').parent().attr("data-year")+"/"+( parseInt($('.ui-state-active').parent().attr("data-month")) +1)+"/"+$('.ui-state-active').html()+" "+$('#hrs').val()+":"+$('#mins').val();
$('#mydate').val(myDate);
